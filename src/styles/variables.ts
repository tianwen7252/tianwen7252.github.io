...
export const KEYBOARD_TAG_FONT_SIZE = '1rem'
export const KEYBOARD_DATE_FONT_SIZE = '.85rem'
export const KEYBOARD_TAB_FONT_SIZE = '1.1rem'
export const KEYBOARD_MODE_COMM_TAB_FONT_SIZE = '1.1rem'
export const KEYBOARD_BTN_FONT_SIZE = '1.128rem'
export const KEYBOARD_MODE_COMM_BTN_FONT_SIZE = '1.4rem'
...
export const ORDER_CARD_FONT_SIZE = '1.1rem'
