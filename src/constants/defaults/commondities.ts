...
export const COMMODITIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '雞肉絲', price: 50, priority: 1 },
      { name: '京醬肉絲', price: 65, priority: 2 },
      { name: '糖醋雞丁', price: 65, priority: 3 },
      { name: '排骨', price: 70, priority: 4 },
      { name: '蒜泥白肉', price: 70, priority: 5 },
      { name: '無骨雞排', price: 50, priority: 6 },
