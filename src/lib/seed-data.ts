...
function com(
  ...
  return { id, typeId, name, price, priority, onMarket: true, hideOnMode, createdAt: T, updatedAt: T }
}

export const SEED_COMMONDITIES: readonly Commondity[] = [
  // ── 🍱 餐盒 (main-dish / bento) ──
  com('com-001', 'bento', '油淋雞腿飯', 140, 1),
  com('com-002', 'bento', '炸雞腿飯', 130, 2),
  com('com-003', 'bento', '滷雞腿飯', 130, 3),
  com('com-004', 'bento', '魚排飯', 110, 4),
  com('com-005', 'bento', '排骨飯', 115, 5),
  com('com-006', 'bento', '焢肉飯', 115, 6),
  com('com-007', 'bento', '蒜泥白肉飯', 115, 7),
  com('com-008', 'bento', '京醬肉絲飯', 110, 8),
  com('com-009', 'bento', '糖醋雞丁飯', 110, 9),
  com('com-010', 'bento', '雞肉絲飯', 100, 10),
  com('com-011', 'bento', '無骨雞排飯', 100, 11),
  com('com-012', 'bento', '蔬菜飯', 80, 12),
  com('com-013', 'bento', '大雞肉飯', 60, 13),
  com('com-014', 'bento', '小雞肉飯', 45, 14),
  com('com-015', 'bento', '雞胸肉沙拉', 160, 15),
  com('com-016', 'bento', '加蛋', 15, 16, 'both'),
  com('com-017', 'bento', '加菜', 15, 17, 'both'),

  // ── 🍖 單點 (à-la-carte / single) ──
  com('com-101', 'single', '油淋雞腿', 100, 1),
  com('com-102', 'single', '炸雞腿', 90, 2),
  com('com-103', 'single', '滷雞腿', 90, 3),
  com('com-104', 'single', '魚排', 65, 4),
  com('com-105', 'single', '排骨', 75, 5),
  com('com-106', 'single', '焢肉', 75, 6),
  com('com-107', 'single', '蒜泥白肉', 75, 7),
  com('com-108', 'single', '京醬肉絲', 70, 8),
  com('com-109', 'single', '糖醋雞丁', 70, 9),
  com('com-110', 'single', '雞肉絲', 55, 10),
  com('com-111', 'single', '無骨雞排', 55, 11),
  com('com-112', 'single', '蔬菜', 30, 12),
  ...
  // ── 🥟 水餃 (dumpling) ──
  com('com-301', 'dumpling', '干貝水餃', 275, 1),
  com('com-302', 'dumpling', '招牌水餃', 240, 2),
  com('com-303', 'dumpling', '韭菜水餃', 240, 3),
  com('com-304', 'dumpling', '養生水餃', 275, 4),
  com('com-305', 'dumpling', '玉米水餃', 240, 5),
] as const
