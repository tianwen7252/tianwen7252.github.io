...
`,lt=(e,t=e)=>l`
  ...
  `,Rr=Ze(fe.brown),Mr=Ze(fe.purple),Sr=Ze(fe.blue),Br=Ze(fe.gold),Nr=Ze(fe.red),Pr={brown:Rr,purple:Mr,blue:Sr,gold:Br,red:Nr},zr={SwapLeftOutlined:n(ra,{}),PlusOutlined:n(oa,{}),DeleteOutlined:n(Et,{}),CloseOutlined:n(sa,{})},Kt=[1e3,500,100];function Lr(e){const t=e.toString(),{length:a}=t,i=+t[0],o=[];return a<=4&&a>1?(Kt.forEach((r,c)=>{if(r>e)o.push([r,r,r-e]);else if(e>r){const u=r*(i+1);u>e&&(u<Kt[c-1]||c===0)&&o.push([r,u,u-e])}}),o):null}const Yr=s.memo(e=>{var Ge;const{API:t,appEvent:a,isTablet:i}=s.useContext(Xe),o=Pe(async()=>(await t.commondityTypes.get()).map(b=>({key:b.id,...b})),[],[]),r=Pe(async()=>await t.commondity.getMapData(),[],{}),c=Pe(async()=>await t.orderTypes.get(),[],[]),{data:u,total:d,priceMap:m,input:h,updateItemRes:x,update:C,clear:k}=tr(r),{editMode:D=!1,record:Y,lastRecordNumber:B,drawerMode:Z=!1,callOrderAPI:ee,submitCallback:y}=e,[v,w]=s.useState(e.mode||"both"),[p,N]=s.useState([]),[V,te]=s.useState(tt.KEYBOARD_SUBMIT_BTN_TEXT),[H,q]=s.useState(D),[E,F]=s.useState(!1),[I,oe]=s.useState(null),[he,le]=s.useState(""),[se,$e]=s.useState(!1),He=s.useRef(Y),de=s.useMemo(()=>{let g=0;return u.forEach(({res:b,type:T,amount:A=""})=>{!tt.NO_NEED_SOUP_KEYWORDS.some(P=>b==null?void 0:b.includes(P))&&(T===tt.MAIN_DISH_TYPE||b==="湯")&&(g+=it(A))}),g},[u]),Ae=s.useMemo(()=>p.includes("不要湯"),[p]),ge=s.useCallback(g=>{const[b,T]=g.split("|");return h(b,T).data},[h]),dt=s.useCallback(g=>{w(g)},[w]),De=s.useCallback(g=>{const{meta:b=""}=g.currentTarget.dataset;ge(b)},[ge]),O=s.useCallback(g=>{const{key:b}=g;i?x(b):ge(b)},[i,ge,x]),L=s.useCallback((g,b=!1,T)=>{const{key:A}=T;x(A,g,b)},[x]),R=s.useCallback((g,b)=>{const T=p.indexOf(g);b?T===-1&&p.push(g):p.splice(T,1),N([...p])},[p]),ie=s.useCallback(()=>{F(!0)},[]),ye=s.useCallback(()=>{I===null||I===d?(oe(null),$e(!1)):(p.includes("優惠價")||N([...p,"優惠價"]),$e(!0)),F(!1)},[I,d,p]),ne=s.useCallback(()=>{$e(!1),oe(null),le(""),p.includes("優惠價")&&N([...Nn(p,"優惠價")]),F(!1)},[p]),pe=s.useCallback(()=>{ge("Escape"),N([]),ne(),Z||(te(tt.KEYBOARD_SUBMIT_BTN_TEXT),q(!1),a.fire(a.ORDER_AFTER_ACTION)),He.current=null,k()},[Z,a,ge,k,ne]),Fe=s.useCallback(async()=>{const g=se?I:d;if(g>0){let b="add";const T={data:u,number:B+1,total:g,originalTotal:se?d:void 0,editedMemo:he,soups:de,memo:!de||Ae?p:[...p,`${de}杯湯`]};if(H){const A=He.current;delete T.number,b="edit",A&&ee({...A,...T},b)}else await ee(T,b);y==null||y(b),pe()}},[u,B,d,de,H,Ae,p,se,I,he,ee,y,pe]);s.useEffect(()=>{const g=a.on(a.KEYBOARD_ON_ACTION,T=>{const{record:A,action:_}=T.detail;switch(_){case"edit":{const{data:P,memo:M,number:z,editedMemo:G}=A;let{total:X,originalTotal:U}=A;He.current=A,vt(U)||(oe(X),le(G),$e(!0),X=U),C(P,X),N(M.filter(ae=>!ae.includes("杯湯"))),te(`編輯訂單 - 編號[${z}]`),q(!0);break}case"delete":{ee(A,"delete");break}}}),b=a.on(a.KEYBOARD_ON_CANCEL_EDIT,pe);return()=>{g(),b()}},[a,C,ee,pe]);const Ve=s.useMemo(()=>Ra.map((g,b)=>n(K,{gap:"middle",children:g.map((T,A)=>{const{label:_,meta:P,icon:M}=T;return n(Ue,{shape:"circle",size:"large","data-meta":P,icon:zr[M],onClick:De,children:_},A)})},b)),[De]),Qe=s.useMemo(()=>o.map(g=>{const{type:b,label:T,typeID:A,color:_}=g,M=(r[A]??[]).map((z,G)=>{const{name:X,price:U,menu:ae,visible:Ce,showRelevancy:Q,hideOnMode:ue}=z;if(Ce===!1||ue===v)return null;const me=Q&&ae?`+${U}|${ae[0].name}`:`+${U}|${X}`,W=n(Ue,{size:"large","data-meta":me,css:Ir[_],onClick:De,children:X},`${G}-${me}`);return ae?n(Mt,{overlayClassName:Ht,arrow:{pointAtCenter:!0},placement:"bottom",menu:{onClick:O,items:ae.map(({name:re,price:we,textIcon:ve})=>({key:`+${we}|${re}`,label:ve?f(J,{children:[ve,re]}):re}))},children:W},me):W});return{label:T,key:b,children:n(K,{css:Cr,gap:"middle",vertical:!0,wrap:!0,children:M})}}),[v,o,r,De,O]),_e=s.useMemo(()=>u.map((g,b)=>{var M,z;const{value:T,operator:A,res:_}=g;let P;return A?P=f("span",{children:[A,T]}):P=_?f("span",{children:[T,"(",n(Mt,{overlayClassName:Ht,arrow:{pointAtCenter:!0},placement:"bottom",menu:{items:(z=(M=m[T])==null?void 0:M.map)==null?void 0:z.call(M,({name:G})=>({key:`+${T}|${G}`,label:G})),onClick:L.bind(null,g,!1)},children:n(Ct,{bordered:!1,closeIcon:!0,onClose:L.bind(null,g,!0),children:_})},`${b}-${T}`),")"]}):T,n(J,{children:P},`${b}-${T}-${Date.now()}`)}),[u,m,L]),[ke,Ke]=s.useMemo(()=>{const g=[],b=[];return c.forEach(T=>{const{name:A,color:_,type:P}=T,M=n(Ct.CheckableTag,{css:Pr[_],checked:p.includes(A),onChange:z=>R(A,z),children:A},A);P==="meal"?g.push(M):b.push(M)}),[g,b]},[c,p,R]),be=s.useMemo(()=>{var b;const g=se?I:d;return g!==0&&((b=Lr(g))==null?void 0:b.map(([T,A,_])=>f("span",{css:mr,className:`resta-keyboard-change-${T}`,children:["$",A," 找 $",_]},T)))},[se,d,I]),xe=s.useMemo(()=>f(j,{children:[n("span",{css:pr,children:de>0&&!Ae&&`(${de}杯湯)`}),be&&n("span",{css:ur,children:be})]}),[de,Ae,be]);return f("div",{css:[nr,Z&&ir,se&&ar],children:[f(K,{css:[rr,v==="commondity"&&or],className:"resta-keyboard-left",vertical:!0,children:[f(K,{css:sr,className:"resta-keyboard-textArea",vertical:!0,children:[n("div",{css:cr,children:_e}),n("div",{css:Yt,children:f(J,{size:"large",children:[f("span",{css:se&&lr,children:[d&&`= ${ze(d)}`,d!==0&&n(Ue,{type:"text",icon:n(tn,{}),onClick:ie})]}),!se&&xe]})}),se&&n("div",{css:[Yt,dr],children:f(J,{size:"large",children:[n("span",{children:`= ${ze(I)}`}),xe]})})]}),f(K,{css:gr,gap:"middle",vertical:!0,children:[f(J,{size:"middle",children:[n(Wn,{css:hr,options:[{value:"both",icon:n(ia,{})},{value:"commondity",icon:n(ca,{})},{value:"calculator",icon:n(la,{})}],onChange:dt}),n(Ue,{danger:!0,type:"primary",size:"large",css:br,icon:n(Et,{}),onClick:pe,children:"清除"})]}),f(K,{css:yr,gap:"middle",children:[v!=="commondity"&&n("div",{css:fr,children:Ve}),v!=="calculator"&&n(Qt,{css:xr,tabPosition:v==="commondity"?"left":"top",defaultActiveKey:(Ge=o==null?void 0:o[0])==null?void 0:Ge.type,items:Qe})]})]}),n(We,{}),n(K,{css:wr,gap:"small",wrap:!0,align:"center",children:f(J,{css:vr,split:n("span",{css:Er}),children:[n(J,{children:ke}),n(J,{children:Ke})]})}),n(We,{}),n(K,{vertical:!0,children:n(Ue,{css:[Tr,H&&_r],size:"large",type:"primary",disabled:Z&&(u==null?void 0:u.length)===0,onClick:Fe,children:V})})]}),n(Jt,{title:"設定訂單總金額",open:E,okText:"確定修改",cancelText:"取消 (還原)",closable:!1,maskClosable:!1,onOk:ye,onCancel:ne,children:n(K,{vertical:!0,children:f(et,{labelCol:{span:4},wrapperCol:{span:18},css:kr,children:[n(et.Item,{label:"目前金額",children:ze(d)}),n(et.Item,{label:"修改金額",children:n(Gn,{type:"number",prefix:"$",value:I===null?d:I,min:0,style:{minWidth:"60%"},addonAfter:`($${Xa(I===null?d:I)})`,onChange:s.useCallback(g=>oe(g),[])})}),n(et.Item,{label:"備註",children:n(Un,{type:"text",placeholder:"請輸入備註",value:he,onChange:s.useCallback(g=>le(g.target.value),[])})})]})})})]})}),Gt=42*2-1,fn="linear-gradient(to top, #dbd5a7, #b0dab9)",Hr="linear-gradient(to bottom, #fb578e, #f7bb97)",Fr=l`
