import{r as a,Z as u,aa as V,ad as P,a2 as e,a1 as h,a3 as H,R as xe,ao as Ce,ap as ke,aq as Q,ar as Ie,as as ve}from"./vendor-BMtVWkdh.js";import{S as we}from"./StickyHeader-CPhcGxsU.js";import{A as ie,L as Te,M as Se,q as Re,N as De}from"./index-DMN5WkFw.js";import{s as ae,M as Me,I as z,l as F,B as I,b as se,F as Oe,d as $e,h as x,m as ce,R as j,n as w,g as T,o as S,S as Z}from"./antd-KrJE-QeB.js";import{ac as G,bw as W,bx as X,bm as ee,bi as Ae,by as Be,bz as Ee,bA as Ne,bB as Ue,bC as _e}from"./antd-deps-BNgUvvwQ.js";import"./mathjs-BiAxHkVp.js";const J={product:{}},Le={storage:J,updateStorage:()=>{},setInitialStorage:m=>{}},le=a.createContext(Le),Ve=u`
  padding: 20px;
`,q=u`
  margin-bottom: 20px;
`,Pe=u`
...
`,We=u`
  ...
  top: 5px;
  font-size: 1rem;
`,Xe=[{key:"info",icon:e(Be,{}),label:"系統資訊",children:e(Je,{})},{key:"product",icon:e(Ee,{}),label:"商品設定",children:e(je,{})},{key:"stuff",icon:e(Ne,{}),label:"員工設定"},{key:"cost",icon:e(Ue,{}),label:"每月成本"},{key:"cloud",icon:e(_e,{}),label:"雲端同步"}],et=()=>{const{API:m}=a.useContext(ie),i=a.useMemo(()=>({...J}),[]),f=a.useMemo(()=>Q(J),[]),[R,D]=a.useState(!1),k=a.useCallback(()=>{console.log("comparison",i,f),D(JSON.stringify(i)!==JSON.stringify(f))},[i,f]),M=a.useCallback(()=>{const{product:{commondityTypes:C,commondities:g,orderTypes:O}}=i;C.forEach(A=>{m.commondityTypes.set(A.id,A)}),D(!1)},[i,f,k,m]),E=a.useMemo(()=>({storage:i,updateStorage:k,setInitialStorage:C=>{Ie(f,C,Q(ve(i,C))),console.log("init",C,i,f)}}),[i,f,k]);return e(le.Provider,{value:E,children:h("div",{css:Qe,children:[h(we,{cls:Ye,children:[h(Z,{css:Ke,children:[e(Ae,{}),e("label",{children:"系統設定"}),R&&e(Z,{children:e(ce,{css:Ge,description:"設定尚未存檔",type:"warning",showIcon:!0})})]}),R&&e(I,{css:We,size:"small",type:"primary",onClick:M,children:"存檔設定 (未完成)"})]}),e("div",{css:Ze,children:e(se,{items:Xe,defaultActiveKey:"info",destroyInactiveTabPane:!0})})]})})},st=et;export{et as Component,st as Settings,st as default};
