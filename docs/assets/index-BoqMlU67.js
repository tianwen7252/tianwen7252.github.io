import{r as a,bG as u,bY as V,c7 as P,bK as e,bJ as h,an as Q,bL as H,cm as G,cn as W,c0 as X,R as xe,co as Ce,cp as ke,cq as Z,cr as Ie,cs as ve,bQ as we,ct as Te,cu as Se,cv as Re,cw as De,cx as Me}from"./vendor-ONl0qZS6.js";import{S as Oe}from"./StickyHeader-u-FBCCY0.js";import{A as ie,L as $e,M as Ae,q as Be,N as Ee}from"./index-G73Dr-ix.js";import{s as ae,M as Ne,I as z,l as F,B as I,b as se,F as Ue,d as _e,h as x,m as ce,R as j,n as w,g as T,o as S,S as ee}from"./antd-CvNDq1s1.js";import"./mathjs-CIvf5Fa-.js";const J={product:{}},Le={storage:J,updateStorage:()=>{},setInitialStorage:m=>{}},le=a.createContext(Le),Ve=u`
  padding: 20px;
`,q=u`
  margin-bottom: 20px;
`,Pe=u`
...
`,Xe=u`
  ...
  top: 5px;
  font-size: 1rem;
`,Ze=[{key:"info",icon:e(Te,{}),label:"系統資訊",children:e(Je,{})},{key:"product",icon:e(Se,{}),label:"商品設定",children:e(je,{})},{key:"stuff",icon:e(Re,{}),label:"員工設定"},{key:"cost",icon:e(De,{}),label:"每月成本"},{key:"cloud",icon:e(Me,{}),label:"雲端同步"}],et=()=>{const{API:m}=a.useContext(ie),i=a.useMemo(()=>({...J}),[]),g=a.useMemo(()=>Z(J),[]),[R,D]=a.useState(!1),k=a.useCallback(()=>{console.log("comparison",i,g),D(JSON.stringify(i)!==JSON.stringify(g))},[i,g]),M=a.useCallback(()=>{const{product:{commondityTypes:C,commondities:f,orderTypes:O}}=i;C.forEach(A=>{m.commondityTypes.set(A.id,A)}),D(!1)},[i,g,k,m]),E=a.useMemo(()=>({storage:i,updateStorage:k,setInitialStorage:C=>{Ie(g,C,Z(ve(i,C))),console.log("init",C,i,g)}}),[i,g,k]);return e(le.Provider,{value:E,children:h("div",{css:Qe,children:[h(Oe,{cls:Ye,children:[h(ee,{css:Ke,children:[e(we,{}),e("label",{children:"系統設定"}),R&&e(ee,{children:e(ce,{css:We,description:"設定尚未存檔",type:"warning",showIcon:!0})})]}),R&&e(I,{css:Xe,size:"small",type:"primary",onClick:M,children:"存檔設定 (未完成)"})]}),e("div",{css:Ge,children:e(se,{items:Ze,defaultActiveKey:"info",destroyInactiveTabPane:!0})})]})})},at=et;export{et as Component,at as Settings,at as default};
