const __vite__fileDeps=["./index-D-Mr9mM9.js","./vendor-BMtVWkdh.js","./antd-deps-BNgUvvwQ.js","./StickyHeader-CPhcGxsU.js","./antd-KrJE-QeB.js","./mathjs-BiAxHkVp.js","./index-j2gWb3zD.js","./chartjs-C1UQ8T82.js","./index-B7CNRYKQ.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import{C as S,W as _n,X as kn,Q as On,Y as $n,Z as l,r as s,$ as An,a0 as Dn,a1 as f,a2 as n,a3 as W,a4 as In,a5 as Rn,a6 as vt,a7 as Mn,a8 as Sn,a9 as Bn,aa as Pe,ab as Nn,ac as Pn,ad as zn,ae as Rt,af as Oe,ag as Ln,ah as Yn,ai as Hn,aj as Fn,ak as Kn}from"./vendor-BMtVWkdh.js";import{F as Re,B as Ue,a as K,D as Mt,T as Ct,S as J,b as Qt,c as et,d as Gn,I as Un,M as Jt,e as jn,f as je,s as Wn,E as qn,g as Ee,h as Xn,A as Zn,i as Vn,C as Qn}from"./antd-KrJE-QeB.js";import{be as Jn,bf as ea,bg as ta,bh as na,bi as aa,bj as en,bk as tn,bl as ra,ac as oa,bm as Et,r as sa,bn as ia,bo as ca,bp as la,bq as da,br as pa}from"./antd-deps-BNgUvvwQ.js";import{c as ua,e as ma}from"./mathjs-BiAxHkVp.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();S.extend(_n);S.extend(kn);S.extend(On);S.extend($n);S.locale("zh-tw");S.tz.setDefault();const We={KEYBOARD_TEXT_MEALS_HEIGHT:"190px",KEYBOARD_TEXT_MIN_HEIGHT:"250px",ORDER_CARD_WIDTH:"260px"},fa="linear-gradient(to right, #33ceea 0%, #ffd194  51%, #33ceea  100%)",ha="radial-gradient(circle, #ffd194 0%, #33ceea 100%);",ga="0px",ba="1.5rem",ya="2rem",xa=".2rem",nn=".9rem",an=".85rem",St="1rem",Ca="1.1rem",Bt="250px",Nt="190px",rn="284px";function on(e="all",t=1){return`${e} ${t}s cubic-bezier(0.075, 0.82, 0.165, 1)`}function wa(e=0){return`calc(100vw - ${e}px);`}function Tt(e=0){return`calc(100vh - ${e}px - ${ga});`}function va(e={}){const{width:t="200px",height:a="200px",innerWidth:i="150px",innerHeight:o="150px",rtColor:r="#F4D8DD",rbColor:c="#C9DDE7",lbColor:u="#F3EFE6",ltColor:d="#D5EAE5"}=e;return`
    width: ${t};
    height: ${a};
    display: flex;
...
`,sr=l`
  ...
  @media only screen and (min-device-width: 1080px) and (orientation: landscape) {
    min-height: ${We.KEYBOARD_TEXT_MIN_HEIGHT};
  }
...
`,ir=l`
  ...
  .resta-keyboard-textArea {
    @media only screen and (min-device-width: 1080px) and (orientation: landscape) {
      min-height: calc(${We.KEYBOARD_TEXT_MEALS_HEIGHT} + 20px);
      max-height: calc(${We.KEYBOARD_TEXT_MEALS_HEIGHT} + 20px);
    }
    @media only screen and (min-device-width: 1280px) and (orientation: landscape) {
      max-height: none;
    }
...
`,cr=l`
  ...
  @media only screen and (min-device-width: 1080px) and (orientation: landscape) {
    max-height: calc(
      ${We.KEYBOARD_TEXT_MEALS_HEIGHT} - var(--resta-original-total-room)
    );
  }
  @media only screen and (min-device-width: 1280px) and (orientation: landscape) {
    max-height: calc(
...
`,lt=(e,t=e)=>l`
  ...
  `,Rr=Ze(fe.brown),Mr=Ze(fe.purple),Sr=Ze(fe.blue),Br=Ze(fe.gold),Nr=Ze(fe.red),Pr={brown:Rr,purple:Mr,blue:Sr,gold:Br,red:Nr},zr={SwapLeftOutlined:n(ra,{}),PlusOutlined:n(oa,{}),DeleteOutlined:n(Et,{}),CloseOutlined:n(sa,{})},Kt=[1e3,500,100];function Lr(e){const t=e.toString(),{length:a}=t,i=+t[0],o=[];return a<=4&&a>1?(Kt.forEach((r,c)=>{if(r>e)o.push([r,r,r-e]);else if(e>r){const u=r*(i+1);u>e&&(u<Kt[c-1]||c===0)&&o.push([r,u,u-e])}}),o):null}const Yr=s.memo(e=>{var Ge;const{API:t,appEvent:a,isTablet:i}=s.useContext(Xe),o=Pe(async()=>(await t.commondityTypes.get()).map(y=>({key:y.id,...y})),[],[]),r=Pe(async()=>await t.commondity.getMapData(),[],{}),c=Pe(async()=>await t.orderTypes.get(),[],[]),{data:u,total:d,priceMap:m,input:h,updateItemRes:x,update:C,clear:k}=tr(r),{editMode:D=!1,record:Y,lastRecordNumber:B,drawerMode:Z=!1,callOrderAPI:ee,submitCallback:b}=e,[v,w]=s.useState(e.mode||"both"),[p,N]=s.useState([]),[V,te]=s.useState(tt.KEYBOARD_SUBMIT_BTN_TEXT),[H,q]=s.useState(D),[E,F]=s.useState(!1),[I,oe]=s.useState(null),[he,le]=s.useState(""),[se,$e]=s.useState(!1),He=s.useRef(Y),de=s.useMemo(()=>{let g=0;return u.forEach(({res:y,type:T,amount:A=""})=>{!tt.NO_NEED_SOUP_KEYWORDS.some(P=>y==null?void 0:y.includes(P))&&(T===tt.MAIN_DISH_TYPE||y==="湯")&&(g+=it(A))}),g},[u]),Ae=s.useMemo(()=>p.includes("不要湯"),[p]),ge=s.useCallback(g=>{const[y,T]=g.split("|");return h(y,T).data},[h]),dt=s.useCallback(g=>{w(g)},[w]),De=s.useCallback(g=>{const{meta:y=""}=g.currentTarget.dataset;ge(y)},[ge]),O=s.useCallback(g=>{const{key:y}=g;i?x(y):ge(y)},[i,ge,x]),L=s.useCallback((g,y=!1,T)=>{const{key:A}=T;x(A,g,y)},[x]),R=s.useCallback((g,y)=>{const T=p.indexOf(g);y?T===-1&&p.push(g):p.splice(T,1),N([...p])},[p]),ie=s.useCallback(()=>{F(!0)},[]),be=s.useCallback(()=>{I===null||I===d?(oe(null),$e(!1)):(p.includes("優惠價")||N([...p,"優惠價"]),$e(!0)),F(!1)},[I,d,p]),ne=s.useCallback(()=>{$e(!1),oe(null),le(""),p.includes("優惠價")&&N([...Nn(p,"優惠價")]),F(!1)},[p]),pe=s.useCallback(()=>{ge("Escape"),N([]),ne(),Z||(te(tt.KEYBOARD_SUBMIT_BTN_TEXT),q(!1),a.fire(a.ORDER_AFTER_ACTION)),He.current=null,k()},[Z,a,ge,k,ne]),Fe=s.useCallback(async()=>{const g=se?I:d;if(g>0){let y="add";const T={data:u,number:B+1,total:g,originalTotal:se?d:void 0,editedMemo:he,soups:de,memo:!de||Ae?p:[...p,`${de}杯湯`]};if(H){const A=He.current;delete T.number,y="edit",A&&ee({...A,...T},y)}else await ee(T,y);b==null||b(y),pe()}},[u,B,d,de,H,Ae,p,se,I,he,ee,b,pe]);s.useEffect(()=>{const g=a.on(a.KEYBOARD_ON_ACTION,T=>{const{record:A,action:_}=T.detail;switch(_){case"edit":{const{data:P,memo:M,number:z,editedMemo:G}=A;let{total:X,originalTotal:U}=A;He.current=A,vt(U)||(oe(X),le(G),$e(!0),X=U),C(P,X),N(M.filter(ae=>!ae.includes("杯湯"))),te(`編輯訂單 - 編號[${z}]`),q(!0);break}case"delete":{ee(A,"delete");break}}}),y=a.on(a.KEYBOARD_ON_CANCEL_EDIT,pe);return()=>{g(),y()}},[a,C,ee,pe]);const Ve=s.useMemo(()=>Ra.map((g,y)=>n(K,{gap:"middle",children:g.map((T,A)=>{const{label:_,meta:P,icon:M}=T;return n(Ue,{shape:"circle",size:"large","data-meta":P,icon:zr[M],onClick:De,children:_},A)})},y)),[De]),Qe=s.useMemo(()=>o.map(g=>{const{type:y,label:T,typeID:A,color:_}=g,M=(r[A]??[]).map((z,G)=>{const{name:X,price:U,menu:ae,visible:Ce,showRelevancy:Q,hideOnMode:ue}=z;if(Ce===!1||ue===v)return null;const me=Q&&ae?`+${U}|${ae[0].name}`:`+${U}|${X}`,j=n(Ue,{size:"large","data-meta":me,css:Ir[_],onClick:De,children:X},`${G}-${me}`);return ae?n(Mt,{overlayClassName:Ht,arrow:{pointAtCenter:!0},placement:"bottom",menu:{onClick:O,items:ae.map(({name:re,price:we,textIcon:ve})=>({key:`+${we}|${re}`,label:ve?f(J,{children:[ve,re]}):re}))},children:j},me):j});return{label:T,key:y,children:n(K,{css:Cr,gap:"middle",vertical:!0,wrap:!0,children:M})}}),[v,o,r,De,O]),_e=s.useMemo(()=>u.map((g,y)=>{var M,z;const{value:T,operator:A,res:_}=g;let P;return A?P=f("span",{children:[A,T]}):P=_?f("span",{children:[T,"(",n(Mt,{overlayClassName:Ht,arrow:{pointAtCenter:!0},placement:"bottom",menu:{items:(z=(M=m[T])==null?void 0:M.map)==null?void 0:z.call(M,({name:G})=>({key:`+${T}|${G}`,label:G})),onClick:L.bind(null,g,!1)},children:n(Ct,{bordered:!1,closeIcon:!0,onClose:L.bind(null,g,!0),children:_})},`${y}-${T}`),")"]}):T,n(J,{children:P},`${y}-${T}-${Date.now()}`)}),[u,m,L]),[ke,Ke]=s.useMemo(()=>{const g=[],y=[];return c.forEach(T=>{const{name:A,color:_,type:P}=T,M=n(Ct.CheckableTag,{css:Pr[_],checked:p.includes(A),onChange:z=>R(A,z),children:A},A);P==="meal"?g.push(M):y.push(M)}),[g,y]},[c,p,R]),ye=s.useMemo(()=>{var y;const g=se?I:d;return g!==0&&((y=Lr(g))==null?void 0:y.map(([T,A,_])=>f("span",{css:mr,className:`resta-keyboard-change-${T}`,children:["$",A," 找 $",_]},T)))},[se,d,I]),xe=s.useMemo(()=>f(W,{children:[n("span",{css:pr,children:de>0&&!Ae&&`(${de}杯湯)`}),ye&&n("span",{css:ur,children:ye})]}),[de,Ae,ye]);return f("div",{css:[nr,Z&&ir,se&&ar],children:[f(K,{css:[rr,v==="commondity"&&or],className:"resta-keyboard-left",vertical:!0,children:[f(K,{css:sr,className:"resta-keyboard-textArea",vertical:!0,children:[n("div",{css:cr,children:_e}),n("div",{css:Yt,children:f(J,{size:"large",children:[f("span",{css:se&&lr,children:[d&&`= ${ze(d)}`,d!==0&&n(Ue,{type:"text",icon:n(tn,{}),onClick:ie})]}),!se&&xe]})}),se&&n("div",{css:[Yt,dr],children:f(J,{size:"large",children:[n("span",{children:`= ${ze(I)}`}),xe]})})]}),f(K,{css:gr,gap:"middle",vertical:!0,children:[f(J,{size:"middle",children:[n(jn,{css:hr,options:[{value:"both",icon:n(ia,{})},{value:"commondity",icon:n(ca,{})},{value:"calculator",icon:n(la,{})}],onChange:dt}),n(Ue,{danger:!0,type:"primary",size:"large",css:yr,icon:n(Et,{}),onClick:pe,children:"清除"})]}),f(K,{css:br,gap:"middle",children:[v!=="commondity"&&n("div",{css:fr,children:Ve}),v!=="calculator"&&n(Qt,{css:xr,tabPosition:v==="commondity"?"left":"top",defaultActiveKey:(Ge=o==null?void 0:o[0])==null?void 0:Ge.type,items:Qe})]})]}),n(je,{}),n(K,{css:wr,gap:"small",wrap:!0,align:"center",children:f(J,{css:vr,split:n("span",{css:Er}),children:[n(J,{children:ke}),n(J,{children:Ke})]})}),n(je,{}),n(K,{vertical:!0,children:n(Ue,{css:[Tr,H&&_r],size:"large",type:"primary",disabled:Z&&(u==null?void 0:u.length)===0,onClick:Fe,children:V})})]}),n(Jt,{title:"設定訂單總金額",open:E,okText:"確定修改",cancelText:"取消 (還原)",closable:!1,maskClosable:!1,onOk:be,onCancel:ne,children:n(K,{vertical:!0,children:f(et,{labelCol:{span:4},wrapperCol:{span:18},css:kr,children:[n(et.Item,{label:"目前金額",children:ze(d)}),n(et.Item,{label:"修改金額",children:n(Gn,{type:"number",prefix:"$",value:I===null?d:I,min:0,style:{minWidth:"60%"},addonAfter:`($${Xa(I===null?d:I)})`,onChange:s.useCallback(g=>oe(g),[])})}),n(et.Item,{label:"備註",children:n(Un,{type:"text",placeholder:"請輸入備註",value:he,onChange:s.useCallback(g=>le(g.target.value),[])})})]})})})]})}),Gt=42*2-1,fn="linear-gradient(to top, #dbd5a7, #b0dab9)",Hr="linear-gradient(to bottom, #fb578e, #f7bb97)",Fr=l`
  ...
  // for iPad 10
  @media only screen and (max-device-width: 1080px) and (orientation: landscape) {
    --resta-order-card-width: ${We.ORDER_CARD_WIDTH};
  }
...
`,rt=e=>l`
  ...
  `,to={gold:rt(fe.gold),blue:rt(fe.blue),purple:rt(fe.purple),red:rt(fe.red)},no=()=>{},gt=s.memo(e=>{const{record:t,number:a,editable:i=!0,callOrderAPI:o=no}=e,[r,c]=s.useState(!1),[u,d]=s.useState(!1),{API:m,appEvent:h,isTablet:x}=s.useContext(Xe),C=s.useRef(),{data:k,total:D,originalTotal:Y,memo:B,editedMemo:Z,createdAt:ee,updatedAt:b}=t,v=S.tz(ee),w=b&&S.tz(b),p=Pe(async()=>await m.orderTypes.get(),[],[]),N=s.useMemo(()=>{let E="";return Array.isArray(B)&&B.some(F=>{const I=p.find(oe=>oe.name===F);return I&&(E=I.color),I}),E},[B,p]),V=s.useCallback(()=>{c(E=>!E)},[]),te=s.useCallback(E=>{if(i){const{directions:F}=E.detail;F.left?c(!0):F.right&&c(!1)}},[i]),H=s.useCallback(E=>{E==="edit"&&d(!0),h.fire(h.KEYBOARD_ON_ACTION,{record:t,action:E,callOrderAPI:o})},[t,o,h]),q=s.useCallback(()=>{h.fire(h.KEYBOARD_ON_CANCEL_EDIT),d(!1)},[h]);return s.useEffect(()=>{const E=C.current,F=Pn(E);E.addEventListener("swipe",te);const I=h.on(h.ORDER_AFTER_ACTION,()=>{d(!1),c(!1)});return()=>{E.removeEventListener("swipe",te),F.off(),I()}},[h,te]),n("div",{css:[Fr,r&&Kr],className:"resta-order-card",ref:C,children:f(K,{css:hn,children:[n("div",{css:[gn,to[N]],children:f(K,{css:jr,vertical:!0,children:[f(K,{css:Gr,children:[n("div",{css:At,children:a}),!x&&n("span",{css:bn,onClick:V,children:r?n(da,{}):n(pa,{css:Ur})})]}),f("div",{css:Wr,children:[k.map((E,F)=>{const{value:I,operator:oe,res:he}=E;let le;return oe?le=f("span",{children:[n("span",{css:Xr,children:oe}),I]}):le=he?f("span",{children:[I," (",he,")"]}):I,n(J,{children:le},`${F}-${I}`)}),(B==null?void 0:B.length)>0&&f(W,{children:[n(je,{}),n(J,{wrap:!0,children:B.map(E=>n(Ct,{children:E},E))})]}),n(je,{})]}),f("div",{css:qr,children:[f("div",{css:Zr,children:["金額 ",ze(D)]}),!vt(Y)&&f("div",{css:Vr,children:[" ","(原金額: ",ze(Y),")"]}),Z&&n(J,{css:at,children:Z}),f(J,{css:at,children:["訂單編號: ",t.number]}),f(J,{css:at,children:[v.format(wt),f("span",{children:["(",v.fromNow(),")"]})]}),w&&f(J,{css:[at,Qr],children:["更新於: ",w.format(wt),f("span",{children:["(",w.fromNow(),")"]})]})]})]})}),i&&f(K,{css:Jr,children:[u?n("div",{css:Ut,onClick:q,children:n(en,{})}):n("div",{css:Ut,onClick:H.bind(null,"edit"),children:n(tn,{})}),n("div",{css:eo,onClick:H.bind(null,"delete"),children:n(Et,{})})]})]})})}),xn=13,Cn=30,Le=["AM","上午"],Ye=["PM","下午"],ct=["TODAY","今日"],bt={[Le[0]]:Le[1],[Ye[0]]:Ye[1],[ct[0]]:ct[1]},ao=[{title:Le[1],key:Le[0],startTime:"09:00",color:"#fdf4d5"},{title:Ye[1],key:Ye[0],startTime:`${xn}:${Cn}`,color:"#EBF3F7"}];function jt(e,t,a="en"){return e*60+t>=xn*60+Cn?a==="en"?Ye[0]:Ye[1]:a==="en"?Le[0]:Le[1]}const ro=[...ao].reverse(),Ao=l`
  position: relative;
  padding: 20px;
  /* width: ${wa(40)}; */
  min-height: ${Tt(40)};
...
`,Po=l`
  float: left;
  margin: 3px 0;
`,qt={add:"新增訂單失敗",edit:"編輯訂單失敗",delete:"刪除訂單失敗"},mo=["期間總訂單數量","期間總銷售商品數量","期間總營業額"],Me=["訂單數量","銷售商品數量","總營業額","上午營業額","下午營業額"];function fo(e,t){const a=S.tz(t),i=a.format("YYYY-MM-DD");e[i]=e[i]??{periods:ro.map(({title:r,startTime:c,key:u,color:d})=>{const[m,h]=c.split(":");return{title:r,key:u,id:`resta-anchor-${i}-${u}`,createdAt:a.hour(+m).minute(+h).valueOf(),elements:[],elementsProps:[],color:d,total:0,numberCount:0}}),datetime:t,dateWithWeek:a.format($t),AM:{soldCount:0,recordCount:0,total:0},PM:{soldCount:0,recordCount:0,total:0},today:{soldCount:0,recordCount:0,total:0}};const o=e[i];return{dateData:o,periods:o.periods}}function ho(e,t=!0){return Object.keys(e).sort((a,i)=>t?i.localeCompare(a):a.localeCompare(i))}function Xt(e){const t=new Map;let a=!1;for(const{res:i,amount:o,type:r,value:c}of e.data){if(!i)continue;const u=t.get(i);(u==null?void 0:u.type)===r?(a=!0,u.amount+=it(o)):t.set(i,{amount:it(o),type:r,value:c})}if(a&&t.size){const i=Array.from(t).flatMap(([o,{amount:r,type:c,value:u}])=>[{res:o,type:c,value:u,...r>1?{amount:String(r)}:{}},...r>1?[{value:String(r),operator:"*"}]:[],{value:"",operator:"+"}]).slice(0,-1);e.data=i}}const Zt="today";function go({datetime:e,searchData:t,dateOrder:a=!0,searchUI:i=!0,reverse:o=!0,orderPageMode:r=!1,vertical:c=r,emptyDescription:u,offset:d=0,limit:m=Wa,handleRecords:h,search:x}){e=e??Zt;const C=S.tz(),k=C.format($t),{API:D}=s.useContext(Xe),[Y,B]=Wn.useNotification(),[Z,ee]=Jt.useModal(),[b,v]=s.useMemo(()=>e===Zt?[C.startOf("day").valueOf(),C.endOf("day").valueOf()]:e,[e,k]),w=s.useCallback(()=>{const O=S.tz();return jt(O.hour(),O.minute())},[k]),[p,N]=s.useState(w),[V,te]=s.useState([]),H=s.useCallback(zn(O=>{te(O)},500),[]),q=s.useRef(),E=s.useCallback((O=!1)=>n(K,{css:co,children:n(qn,{description:O?"查無資料":u,style:{marginTop:100}})}),[u]),F=s.useCallback(({type:O,message:L="系統通知",description:R,errorDescription:ie,errorMsg:be})=>{Y[O]({message:L,description:ie?f(W,{children:[n("p",{children:ie}),n("p",{children:f("small",{children:["錯誤代碼 - ",be??"Unknown"]})})]}):R,showProgress:!0,pauseOnHover:O!=="success",duration:O==="success"?3:20})},[Y]),I=s.useCallback(async(O,L)=>{try{switch(L){case"add":{Xt(O);const R=await D.orders.add(O);return F({message:"",type:"success",description:"新增訂單成功!"}),R}case"edit":{Xt(O);const R=await D.orders.set(O.id,O);return F({message:"",type:"success",description:`編輯訂單[${O.number}]成功!`}),R}case"delete":return new Promise(R=>{Z.confirm({title:"你知道你正在做什麼嗎",content:f(W,{children:[f("p",{children:["確定要刪除訂單[",O.number,"]?"]}),n(je,{})]}),okType:"danger",okText:"不要吵給我刪掉",cancelText:"取消，我不小心按到",onOk:ie=>{D.orders.delete(O.id,O),F({type:"success",description:`刪除訂單[${O.number}]成功!`}),ie(),R(O.id)},onCancel:()=>{R(null)},footer:(ie,{OkBtn:be,CancelBtn:ne})=>f(W,{children:[n(be,{}),n(ne,{})]})})})}}catch(R){F({type:"error",message:"系統發生錯誤",errorDescription:L==="add"?qt[L]:`${qt[L]} - 訂單編號[${O.number}]`,errorMsg:R==null?void 0:R.message})}finally{if(L==="add"){const R=w();R!==p&&N(R)}}return null},[D,Z,p,w,F]),oe=Pe(async()=>{const O=await D.orders.get({startTime:b,endTime:v,reverse:o,searchText:t??V,search:x}),L=(h==null?void 0:h(O))??O;let R=0,ie=0,be=0,ne=[],pe=null,Fe=null,Ve=null,Qe=null;const _e={},ke=L==null?void 0:L.length;if(ke||V.length){const Ke=!!(ke===0&&V.length);L==null||L.forEach(_=>{const{data:P,total:M,createdAt:z}=_,{dateData:G,periods:X}=fo(_e,z);R+=M,++G.today.recordCount;let U=0;P.forEach(({res:j,amount:re})=>{if(j){const we=it(re);U+=we,G.today.soldCount+=we}});const ae=S.tz(z),Ce=jt(ae.hour(),ae.minute()),Q=G[Ce];++Q.recordCount,Q.total+=M,Q.soldCount+=U,ie+=U;const ue=j=>{++j.numberCount;const{elements:re,elementsProps:we,numberCount:ve}=j;j.total+=M;const Ie=`${z}-${ve}`;r?we.push({record:_,key:Ie,number:ve,callOrderAPI:I}):re.push(n(gt,{record:_,number:ve,callOrderAPI:I},Ie))};if(!X.some(j=>{const{createdAt:re}=j;return z>=re?(ue(j),!0):!1})){const j=X.at(-1);ue(j)}}),ne=ho(_e,a),be=ne.length,m&&(ne=ne.slice(d,d+m));const ye={};let xe=null;if(r){if(xe=_e[Object.keys(_e)[0]],xe){const{periods:_}=xe,P=[],M=_.map(({elements:z,elementsProps:G,numberCount:X,title:U,key:ae,createdAt:Ce})=>(G.forEach((Q,ue)=>{Q.number=X-ue;const me=`${Ce}-${Q.number}`;z.push(Rt(gt,{...Q,key:me}));const j=Q.record.number;Q.number=j,P.push(Rt(gt,{...Q,key:`${Ce}-${j}`}))}),{label:U,key:ae,children:n(K,{gap:10,wrap:!0,children:z})})).reverse();M.push({label:ct[1],key:ct[0],children:n(K,{gap:10,wrap:!0,children:P})}),Fe=n(Qt,{tabPosition:"right",items:M,activeKey:p,onChange:N})}}else ne.forEach(_=>{const P=`resta-anchor-${_}`,M=_e[_],{periods:z,dateWithWeek:G,datetime:X}=M,U=_.split("-")[0],ae=`resta-anchor-${U}`,Ce=ye[U]=ye[U]??{yearId:ae,dateElements:[],anchorItems:[]},{dateElements:Q,anchorItems:ue}=Ce,me=S.tz(X).format(ja);ue.push({key:`${U}-${me}`,href:`#${P}`,title:me,children:[]}),!r&&z.reverse();const j=z.filter(({elements:pt})=>pt.length).map(({elements:pt,id:Je,color:En,title:It})=>{const Tn={backgroundColor:En};return ue.at(-1).children.push({key:Je,href:`#${Je}`,title:It}),n(K,{css:io,id:Je,"data-title":It,vertical:c,gap:10,wrap:!0,style:Tn,children:pt},Je)}),{today:re,AM:we,PM:ve}=M,Ie=Math.round(we.total),Dt=Math.round(ve.total),wn=Ie+Dt,vn=f("section",{css:so,children:[n("h1",{id:P,children:G}),f(K,{css:Wt,justify:"space-between",children:[n(Ee,{title:Me[0],value:re.recordCount}),n(Ee,{title:Me[1],value:re.soldCount}),n(Ee,{title:Me[3],prefix:"$",value:Ie}),n(Ee,{title:Me[4],prefix:"$",value:Dt}),n(Ee,{title:Me[2],prefix:"$",value:wn})]}),j]},_);Q.push(vn)});if(!Ke){const _={css:uo};if(!r){const P=[],M=Object.keys(ye);a&&M.sort().reverse(),Fe=M.map(z=>{const{yearId:G,dateElements:X,anchorItems:U}=ye[z];return P.push({key:z,href:`#${G}`,title:z,children:U}),n("article",{id:G,children:X},G)}),Ve=n(Zn,{..._,items:P,offsetTop:64,targetOffset:100,bounds:220})}}pe=n(K,{css:oo,gap:8,ref:q,children:f("div",{css:[lo,!c&&po],children:[i&&n(Xn,{placeholder:"找什麼呢?",mode:"tags",style:{width:"100%"},allowClear:!0,onChange:H,onKeyUp:_=>{_.preventDefault(),_.stopPropagation()},options:Ma}),Ke?E(Ke):n(W,{children:n("div",{className:"resta-orders-content",children:Fe})})]})}),R=Math.round(R);const Ge=ne.length===1,g=Ge?Me:mo;let y=ke??0,T=ie,A=R;if(r&&xe&&(p==="AM"||p==="PM")){const _=xe[p];y=_.recordCount,T=_.soldCount,A=_.total}Qe=!r&&Ge?null:f(K,{css:Wt,justify:"space-between",children:[n("div",{css:!r&&yt,children:n(Ee,{title:`${r?bt[p]:""}${g[0]}`,value:y})}),n("div",{css:!r&&yt,children:n(Ee,{title:`${r?bt[p]:""}${g[1]}`,value:T})}),n("div",{css:!r&&yt,children:n(Ee,{title:`${r?bt[p]:""}${g[2]}`,prefix:"$",value:A})})]})}else ke===0&&(pe=E());return{records:L,recordLength:ke,totalCount:R,totalDays:be,soldItemsCount:ie,periodsOrder:ne,orderListElement:pe,anchorElement:Ve,summaryElement:Qe}},[b,v,V,p,t,d,m,o,r,a,i,c,h,x]),he=Pe(async()=>{let O=0;if(r){const[L,R]=[C.startOf("day").valueOf(),C.endOf("day").valueOf()];O=await D.orders.count({startTime:L,endTime:R})}return O},[k,r]),{records:le,recordLength:se,totalCount:$e,totalDays:He,soldItemsCount:de,periodsOrder:Ae,orderListElement:ge,anchorElement:dt,summaryElement:De}=oe??{periodsOrder:[]};return{records:le,recordLength:se,totalCount:$e,totalDays:He,soldItemsCount:de,periodsOrder:Ae,lastRecordNumber:he,orderListElement:f(W,{children:[B,ee,ge]}),anchorElement:dt,summaryElement:De,contentRef:q,callOrderAPI:I}}const Vt=[f(W,{children:[n("p",{children:"還沒營業? 今天沒人來? 還是老闆不爽做?"}),n("p",{children:"加油好嗎"})]}),f(W,{children:[n("p",{children:"為什麼今天還要上班"}),n("p",{children:"怎麼還沒有放假呢🥲"})]}),f(W,{children:[n("p",{children:"為什麼是我來夾菜..."}),n("p",{children:"夾菜好開心好快樂🥲"})]}),f(W,{children:[n("p",{children:"用微笑和樂觀面對生活，每一天都會快樂且充實"}),n("p",{children:"只要客人不要太機車😮‍💨"})]}),f(W,{children:[n("p",{children:"今天應該生意會很好，大排長龍，賺到破記錄"}),n("p",{children:"可是我會好累🫠"})]}),f(W,{children:[n("p",{children:"希望今天的奧客會少一點"}),n("p",{children:"然後大家都點菜點很快😇"})]}),f(W,{children:[n("p",{children:"當你看到我的時後，代表今天又是新的開始"}),n("p",{children:"開始倒數晚上8點下班吧"})]})],bo=l`
  position: relative;
  overflow: hidden;
...
`,yo=l`
  position: relative;
`,xo=s.memo(()=>{const{DATE_FORMAT:e}=s.useContext(Xe),{orderListElement:t,summaryElement:a,lastRecordNumber:i,contentRef:o,callOrderAPI:r}=go({datetime:"today",orderPageMode:!0,emptyDescription:Vt[Math.floor(Math.random()*Vt.length)]}),c=s.useCallback(u=>{var d,m,h;u==="add"&&((h=(m=(d=o.current)==null?void 0:d.querySelector(".ant-tabs-tabpane"))==null?void 0:m.scroll)==null||h.call(m,0,0))},[o]);return f("div",{css:bo,children:[n(Yr,{lastRecordNumber:i,callOrderAPI:r,submitCallback:c}),n(Vn,{css:yo,title:f("span",{children:["訂單記錄 - ",S.tz().format(e)]}),getContainer:!1,placement:"right",open:!0,mask:!1,closeIcon:null,footer:a,children:t})]})}),xt=e=>{const t=s.lazy(e);return n(s.Suspense,{children:n(t,{})})},Co=s.memo(()=>{const e=n(xo,{});return n(Ln,{children:f(Oe,{element:n(Ia,{}),children:[n(Oe,{path:"/",element:e}),n(Oe,{path:"order",element:e}),n(Oe,{path:"order-list",element:xt(()=>ut(()=>import("./index-D-Mr9mM9.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url))}),n(Oe,{path:"statistics",element:xt(()=>ut(()=>import("./index-j2gWb3zD.js"),__vite__mapDeps([6,1,2,3,7,4,5]),import.meta.url))}),n(Oe,{path:"settings",element:xt(()=>ut(()=>import("./index-B7CNRYKQ.js"),__vite__mapDeps([8,1,2,3,4,5]),import.meta.url))}),n(Oe,{path:"login",element:n(W,{children:"Login"})})]})})}),wo=Yn([{path:"*",element:n(Co,{})}]),vo=()=>f(Xe.Provider,{value:dn,children:[n(Hn,{styles:[Ea]}),n(Qn,{theme:{components:ka},children:n(Fn,{router:wo})})]});Kn(document.getElementById("root")).render(n(vo,{}));export{Xe as A,fe as C,Ga as D,Yr as K,Oo as L,Sa as M,zt as N,Wa as O,Ua as a,Ma as b,So as c,Ro as d,Bo as e,ze as f,Za as g,Do as h,Xa as i,_t as j,Mo as k,Io as l,Ao as m,va as n,jt as o,it as p,$o as q,No as s,Po as t,go as u};
