const __vite__fileDeps=["./index-CTWU5wNm.js","./vendor-ONl0qZS6.js","./StickyHeader-u-FBCCY0.js","./antd-CvNDq1s1.js","./mathjs-CIvf5Fa-.js","./index-CIsq0wyd.js","./chartjs-czLD08pJ.js","./index-BoqMlU67.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import{bp as S,bD as _n,bE as kn,br as On,bF as $n,bG as l,r as s,bH as Dn,bI as An,bJ as f,bK as n,bL as j,bM as In,bN as Rn,bO as Mn,bP as Sn,bQ as Bn,bR as Qt,bS as Nn,bT as Pn,bU as vt,bV as zn,bW as Ln,bX as Yn,bY as Pe,bZ as Hn,b_ as Jt,b$ as Fn,an as Kn,c0 as Et,x as Gn,c1 as Un,c2 as Wn,c3 as jn,c4 as qn,c5 as Xn,c6 as Zn,c7 as Vn,c8 as Rt,c9 as Oe,ca as Qn,cb as Jn,cc as ea,cd as ta,ce as na}from"./vendor-ONl0qZS6.js";import{F as Re,B as Ue,a as K,D as Mt,T as Ct,S as J,b as en,c as et,d as aa,I as ra,M as tn,e as oa,f as We,s as sa,E as ia,g as Ee,h as ca,A as la,i as da,C as pa}from"./antd-CvNDq1s1.js";import{c as ua,e as ma}from"./mathjs-CIvf5Fa-.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function a(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=a(o);fetch(o.href,r)}})();S.extend(_n);S.extend(kn);S.extend(On);S.extend($n);S.locale("zh-tw");S.tz.setDefault();const je={KEYBOARD_TEXT_MEALS_HEIGHT:"190px",KEYBOARD_TEXT_MIN_HEIGHT:"250px",ORDER_CARD_WIDTH:"260px"},fa="linear-gradient(to right, #33ceea 0%, #ffd194  51%, #33ceea  100%)",ha="radial-gradient(circle, #ffd194 0%, #33ceea 100%);",ga="0px",ba="1.5rem",ya="2rem",xa=".2rem",nn=".9rem",an=".85rem",St="1rem",Ca="1.1rem",Bt="250px",Nt="190px",rn="284px";function on(e="all",t=1){return`${e} ${t}s cubic-bezier(0.075, 0.82, 0.165, 1)`}function wa(e=0){return`calc(100vw - ${e}px);`}function Tt(e=0){return`calc(100vh - ${e}px - ${ga});`}function va(e={}){const{width:t="200px",height:a="200px",innerWidth:i="150px",innerHeight:o="150px",rtColor:r="#F4D8DD",rbColor:c="#C9DDE7",lbColor:u="#F3EFE6",ltColor:d="#D5EAE5"}=e;return`
    width: ${t};
    height: ${a};
    display: flex;
...
`,yo=l`
  position: relative;
`,xo=s.memo(()=>{const{DATE_FORMAT:e}=s.useContext(Xe),{orderListElement:t,summaryElement:a,lastRecordNumber:i,contentRef:o,callOrderAPI:r}=go({datetime:"today",orderPageMode:!0,emptyDescription:Vt[Math.floor(Math.random()*Vt.length)]}),c=s.useCallback(u=>{var d,m,h;u==="add"&&((h=(m=(d=o.current)==null?void 0:d.querySelector(".ant-tabs-tabpane"))==null?void 0:m.scroll)==null||h.call(m,0,0))},[o]);return f("div",{css:bo,children:[n(Yr,{lastRecordNumber:i,callOrderAPI:r,submitCallback:c}),n(da,{css:yo,title:f("span",{children:["訂單記錄 - ",S.tz().format(e)]}),getContainer:!1,placement:"right",open:!0,mask:!1,closeIcon:null,footer:a,children:t})]})}),xt=e=>{const t=s.lazy(e);return n(s.Suspense,{children:n(t,{})})},Co=s.memo(()=>{const e=n(xo,{});return n(Qn,{children:f(Oe,{element:n(Ia,{}),children:[n(Oe,{path:"/",element:e}),n(Oe,{path:"order",element:e}),n(Oe,{path:"order-list",element:xt(()=>ut(()=>import("./index-CTWU5wNm.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url))}),n(Oe,{path:"statistics",element:xt(()=>ut(()=>import("./index-CIsq0wyd.js"),__vite__mapDeps([5,1,2,6,3,4]),import.meta.url))}),n(Oe,{path:"settings",element:xt(()=>ut(()=>import("./index-BoqMlU67.js"),__vite__mapDeps([7,1,2,3,4]),import.meta.url))}),n(Oe,{path:"login",element:n(j,{children:"Login"})})]})})}),wo=Jn([{path:"*",element:n(Co,{})}]),vo=()=>f(Xe.Provider,{value:dn,children:[n(ea,{styles:[Ea]}),n(pa,{theme:{components:ka},children:n(ta,{router:wo})})]});na(document.getElementById("root")).render(n(vo,{}));export{Xe as A,fe as C,Ga as D,Yr as K,ko as L,Sa as M,zt as N,ja as O,Ua as a,Ma as b,Mo as c,Io as d,So as e,ze as f,Za as g,Do as h,Xa as i,_t as j,Ro as k,Ao as l,$o as m,va as n,Wt as o,it as p,Oo as q,Bo as s,No as t,go as u};
